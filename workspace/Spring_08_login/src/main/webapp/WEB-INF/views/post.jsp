...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
	...
	@import url('https://fonts.googleapis.com/css?family=Orbitron:400,900|Pacifico|Song+Myung');
		*{margin:0 auto;}
		...
		.my2{background:#fff;}	
		#tit{font-weight:bold; font-size:25px; font-family: 'Song Myung', serif; color:#555; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;}
		#wrt{height:450px; word-wrap: break-word; overflow-y:auto; text-align:left; padding:50px 70px;}	
	</style>
</head>
<body>
	<script>
