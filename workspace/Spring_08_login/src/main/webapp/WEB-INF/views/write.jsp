	...
	@import url('https://fonts.googleapis.com/css?family=Orbitron:400,900|Pacifico');
		*{margin:0 auto;}
		body, html {height: 100%; margin: 0;}
 		#bg{position:fixed; overflow-y:auto; width:100%; height: 100%; background-image:linear-gradient(to right bottom, #E3CEF6, #FA5882, #FF0080, #DF0174, #B40486); background-position: center; background-repeat: no-repeat; background-size: cover;} 
		h1{font-family:'Orbitron', sans-serif; font-weight:bold; color:#fff; text-shadow:0 0 5px #444;}
		.my1{box-shadow:0 5px 10px -5px #333;}
		.my2{background:#fff;}	
		#wrt{height:450px; word-wrap: break-word; overflow-y:auto; text-align:left; padding:50px;}	
				  ...
				  <form action="/writeDone" method="post" id="writeForm">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 rounded-lg border mt-3 p-5 my2">
							  ...
							  <input type="text" id="title" name='title' class="form-control" aria-label="Text input with segmented dropdown button" placeholder="Title for posting...">
							</div>
						<!-- 파일 -->
...
<!-- 								</form> -->
							...
							<div class="row">
								...
								<div id='wrt' class="col-lg-12 col-md-12 col-sm-12 col-xs-12 rounded-lg border mt-3 p-4" contenteditable=true>	
								</div>
							</div>
						</div> 	
					</div> 
