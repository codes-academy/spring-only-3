...
<title>Insert title here</title>
    ...
    <style>
        ...
        .my{border:1px solid black; width:200px; height:300px; margin-top:50px;}
        #chatView{height: 170px; overflow-y:auto;}
    </style>
</head>
<body>
	<script>
...
<!--     </tr> -->
    ...
    <div id="container" class="my">
    	<div id="chatView"></div>
    	<div id="chatInsert">
    		<input type="text" id="input"><button id="chatBtn">chat!</button>
    	</div>
    </div>
    <script>
