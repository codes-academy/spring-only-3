...
<title>Insert title here</title>
	...
	<style>
		...
		.container{width:400px; height:500px; margin:0 auto;}
		.contents{width:100%; height:90%; overflow-y:auto;}
		.control{width:100%; height:10%;}
		.control>input[type="text"]{height:100%; width:80%; box-sizing:border-box;}
		.control>input[type="button"]{height:100%; width:18%; box-sizing:border-box;}
	</style>
<body>
